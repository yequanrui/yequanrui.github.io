(function() {
  ...
  QUnit.test('template', function(assert) {
    ...
    result = namespaceCollisionTemplate({
      pageCount: 3,
      thumbnails: {
        1: 'p1-thumbnail.gif'/*tpa=https://www.html.cn/doc/underscore/test/p1-thumbnail.gif*/,
        2: 'p2-thumbnail.gif'/*tpa=https://www.html.cn/doc/underscore/test/p2-thumbnail.gif*/,
        3: 'p3-thumbnail.gif'/*tpa=https://www.html.cn/doc/underscore/test/p3-thumbnail.gif*/
      }
    });
    assert.strictEqual(result, '3 p3-thumbnail.gif <div class="thumbnail" rel="p1-thumbnail.gif"/*tpa=https://www.html.cn/doc/underscore/test/p1-thumbnail.gif*/></div><div class="thumbnail" rel="p2-thumbnail.gif"/*tpa=https://www.html.cn/doc/underscore/test/p2-thumbnail.gif*/></div><div class="thumbnail" rel="p3-thumbnail.gif"/*tpa=https://www.html.cn/doc/underscore/test/p3-thumbnail.gif*/></div>');
    ...
    assert.strictEqual(mustache({planet: 'World'}), 'Hello World!', 'can mimic mustache.js'/*tpa=https://www.html.cn/doc/underscore/test/can mimic mustache.js*/);
