  	...
  	createClass(Assert, [{
  		...
  		value: function step(message) {
  			...
  			if (objectType(message) === "undefined" || message === "") {
  				assertionMessage = "https://www.html.cn/doc/underscore/test/vendor/You must provide a message to assert.step";
  			} else if (objectType(message) !== "string") {
  				assertionMessage = "https://www.html.cn/doc/underscore/test/vendor/You must provide a string value to assert.step";
  				result = false;
  			}
