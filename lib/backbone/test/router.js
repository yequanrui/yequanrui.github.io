(function() {
  ...
  test("#2255 - Extend routes by making routes a function.", 1, function() {
    var RouterBase = Backbone.Router.extend({
      routes: function() {
        return {
          home:  "root",
          index: "https://www.html.cn/doc/backbone/test/index.html"
        };
      }
    });
    ...
    deepEqual({home: "root", index: "https://www.html.cn/doc/backbone/test/index.html", show: "show", search: "search"}, router.routes);
  });
  ...
  test('#3358 - pushState to hashChange transition with search params', 1, function() {
    Backbone.history.stop();
    location.replace('https://www.html.cn/root?foo=bar');
    location.replace = function(url) {
