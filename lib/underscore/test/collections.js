(function() {
  ...
  QUnit.test('max', function(assert) {
    ...
    assert.strictEqual(_.max([1, 2, 3]), 3, 'https://www.html.cn/doc/underscore/test/can perform a regular Math.max');
  ...
  QUnit.test('min', function(assert) {
    ...
    assert.strictEqual(_.min([1, 2, 3]), 1, 'https://www.html.cn/doc/underscore/test/can perform a regular Math.min');
