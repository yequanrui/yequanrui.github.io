(function() {
  ...
  QUnit.test('first', function(assert) {
    ...
    assert.deepEqual(result, [1, 1], 'https://www.html.cn/doc/underscore/test/works well with _.map');
  ...
  QUnit.test('rest', function(assert) {
    ...
    assert.deepEqual(_.flatten(result), [2, 3, 2, 3], 'https://www.html.cn/doc/underscore/test/works well with _.map');
  });
  ...
  QUnit.test('initial', function(assert) {
    ...
    assert.deepEqual(_.flatten(result), [1, 2, 1, 2], 'https://www.html.cn/doc/underscore/test/works well with _.map');
  });
  ...
  QUnit.test('last', function(assert) {
    ...
    assert.deepEqual(result, [3, 3], 'https://www.html.cn/doc/underscore/test/works well with _.map');
  ...
  QUnit.test('compact', function(assert) {
    ...
    assert.deepEqual(result, [[1], [3]], 'https://www.html.cn/doc/underscore/test/works well with _.map');
  });
